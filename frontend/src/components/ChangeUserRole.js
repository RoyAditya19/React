...
const ChangeUserRole = ({
  ...
  return (
    <div className='fixed w-full h-full z-10 flex justify-between items-center top-0 bottom-0 left-0 right-0 bg-slate-200 bg-opacity-40'>
        <div className='bg-white mx-auto w-full shadow-md p-4 max-w-sm'>
